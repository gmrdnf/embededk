...
public class ChattingClient {
	...
	public ChattingClient(String serverIP, int serverPort, Consumer<String> onMessageReceived) {
	...
	public static void main(String[] args) {
		...
		ChattingClient chattingClient = new ChattingClient("192.168.8.14", 5000, message -> { // 람다(Lambda)메서드 : 일회용
			// 이름없는 메소드
			System.out.println("서버로부터 받은 문자열 : " +"["+name+"]"+ message);
		});
