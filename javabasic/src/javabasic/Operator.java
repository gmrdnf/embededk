...
public class Operator {
	public static void main(String[] args) {
		...
		//전치,후치 연산자
		int i2= ++i1; //i1이 1증가하고 증가된 값이 i2에 할당
		int i3 = i1++; //i1이 i3에 할당된 후 i1이 1증가
...
//		}
		...
		//비트 연산자
		byte b1 = 3;//00000011 2진법 제일 앞의 0은 양수이고 뒤의 7자리는 3을표현하는것
		...
		//1.모든비트를 반전
		//2.1을 더함
		//ex)00000011(십진수3)> 11111100 +1>1111101(십진수-3)
		...
		//관계 연산자 :값의 크기를 비교, 결관느 항상 true 또는 false
		int i6 =10;
		int j6 = 5;
		...
		//|| :앞의 결과가 true이면 뒤에 연산을 수행하지 않음 (why? 전체결과가 true일테니까)
