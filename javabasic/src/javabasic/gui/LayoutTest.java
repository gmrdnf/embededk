...
//		 1.FlowLayout
		...
		for (int i = 1; i <= 3; i++) {
			cardLayoutPanel.add(new JLabel("카드 " + i, SwingConstants.CENTER), "Card" + i);
		}
		...
		gbc.fill = GridBagConstraints.BOTH;// 양쪽모두 채움
		...
		gbc.gridy = 1;
		gbc.gridwidth = 4;
		gridBagLayoutPanel.add(new JButton("버튼4 (0,1,크기:4*1)"), gbc);
